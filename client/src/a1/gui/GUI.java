...
public class GUI {
	...
	//------------------------------------------------------------------------------------------
	// Controls factory
	public static Map<String, ControlFactory> control_types = new TreeMap<String, ControlFactory>();	
	...
	static public void AddType(String name, ControlFactory impl) {
		control_types.put(name, impl);
	}

	static public ControlFactory GetType(String name) {
		return control_types.get(name);
	}
	
	static public boolean HaveType(String name) {
		return control_types.containsKey(name);
	}
	// end factory
	// ------------------------------------------------------------------------------------------
