...
public class BitmapFont {
		...
		private final LinkedHashMap displayLists = new LinkedHashMap(DISPLAY_LIST_CACHE_SIZE, 1, true) {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -1002175983531875674L;
		 ...
		 */
		public BitmapFont(String fntFile, Image image) throws SlickException {
			fontImage = image;
		 ...
		 *             Indicates a failure to load either file
		 */
		public BitmapFont(String fntFile, String imgFile) throws SlickException {
		 ...
		 *             Indicates a failure to load either file
		 */
		public BitmapFont(String fntFile, Image image, boolean caching)
				throws SlickException {
			fontImage = image;
		 ...
		 *             Indicates a failure to load either file
		 */
		public BitmapFont(String fntFile, String imgFile, boolean caching)
				throws SlickException {
			fontImage = new Image(imgFile);
			displayListCaching = caching;
			parseFnt(ResourceLoader.getResourceAsStream(fntFile));
		 ...
		 *             Indicates a failure to load either file
		 */
		public BitmapFont(String name, InputStream fntFile, InputStream imgFile)
				throws SlickException {
		...
		private CharDef parseChar(String line) throws SlickException {
			...
			tokens.nextToken(); // objid
			def.id = Short.parseShort(tokens.nextToken()); // objid value
			if (def.id < 0) {
				return null;
			}
			if (def.id > MAX_CHAR) {
		...
		private class CharDef {
			...
			public String toString() {
				return "[CharDef objid=" + id + " x=" + x + " y=" + y + "]";
			}
