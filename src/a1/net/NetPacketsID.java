...
public class NetPacketsID {
    ...
    static final int GAMESERVER_INVENTORY = 162;
    static final int GAMESERVER_INVENTORY_CLICK = 163;
    static final int GAMESERVER_SET_HAND = 164;
    static final int GAMESERVER_EQUIP = 165;
    static final int GAMESERVER_EQUIP_CLICK = 166;
}
